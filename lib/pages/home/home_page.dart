...
class _HomeState extends State<Home> {
  ...
  checkIsCart() async {
    ...
    if (prefs.containsKey(prebString)) {
      ...
      for (int j = 0; j < Data.homeItems.length; j++)
        for (int i = 0; i < Data.homeItems[j].product.length; i++) {
          var existingCart = cartList.firstWhere(
              (favCall) => favCall.id == Data.homeItems[j].product[i].id,
              orElse: () => null);

          if (existingCart != null) {
            Data.homeItems[j].product[i].isCart = true;
          } else {
            Data.homeItems[j].product[i].isCart = false;
          }
        }
    }
          ...
          children: [
            Wrap(
              children: List.generate(
                Data.homeItems.length,
                (index) {
                  return Column(
                    children: [
                      _item(height, width, index),
                      if (index == 2) _categoriesItem(height, width),
                    ],
                  );
                },
              ),
  ...
  Widget _categoriesItem(double height, double width) => Stack(
        children: [
          Padding(
          ...
          Padding(
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: ListView.builder(
                  scrollDirection: Axis.horizontal,
                  itemCount: Data.homeItems[index].product.length,
                  itemBuilder: (context, index2) => Padding(
                    padding: EdgeInsets.only(
                      left: width * 0.04,
                      top: height * 0.01,
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                            ...
                            child: Column(
                              children: [
                                ...
                                Expanded(
                                  flex: 2,
                                  child: CachedNetworkImage(
                                    imageUrl: Data.homeItems[index]
                                        .product[index2].filePath
                                        .toString(),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            width: width * 0.3,
                                            child: Text(
                                              Data.homeItems[index]
                                                  .product[index2].title
                                                  .toString(),
                                              overflow: TextOverflow.ellipsis,
                                              style: TextStyle(
                                                fontSize: height * 0.02,
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            if (Data.homeItems[index]
                                                    .product[index2].price !=
                                                null)
                                              Text(
                                                Data.homeItems[index]
                                                    .product[index2]
                          ...
                          if (Data.homeItems[index].product[index2].isCart)
                            Container(
                              width: MediaQuery.of(context).size.width * 0.42,
                              height: MediaQuery.of(context).size.height * 0.3,
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Material(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          Data.homeItems[index].product[index2]
                                              .isCart = true;
                                          saveProductCart(index, index2);
                                        },
                                        child: Container(
  ...
  saveProductCart(int index, int index2) async {
    ...
    if (existingCall == null) {
      ...
      prefs.setString(prebString, encodeCalls);
      setState(() {
        Data.homeItems[index].product[index2].isCart = false;
      });
    }
  }
}
