...
class ShopItems extends StatefulWidget {
  ...
  final int back;
  const ShopItems({Key key, this.back}) : super(key: key);
...
class _ShopItemsState extends State<ShopItems> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: Container(
          ...
          child: Column(
            children: <Widget>[
              _top(height, width, arguments["index"], arguments["back"]),
  ...
  Widget _top(double height, double width, int index, int back) => Padding(
        padding: EdgeInsets.only(
          top: height * 0.08,
          left: width * 0.02,
          right: width * 0.02,
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              Data.categoryItems[index].name.toString(),
              style: TextStyle(
